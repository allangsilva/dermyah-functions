...
straight from Secret Manager (e.g. `gcloud secrets versions access latest --secret=dermyah-mongo-url --project=dermyah`) into env vars, write `dermyah-gcs-service-account`'s contents out to
